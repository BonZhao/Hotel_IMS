    ...
    ui(new Ui::Hotel)
{
    ...
    ui->frontDeskButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/taskmgr_normal.png);");
    ui->backDeskButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/keyboard2_normal.png);");
    ui->systemButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/tools_normal.png);");
    ui->pushButton_17->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/info3_normal.png);");
    ...
    if(currentTime.getHour()>=20||currentTime.getHour()<6)//加载背景图片
    {
        ui->day->hide();
        ui->evening->show();
        ui->midnight->hide();
...
void Hotel::on_frontDeskButton_clicked()  //前台
{
    ...
    ui->frontDeskButton->setStyleSheet("border-image: url(:/background/Images/background/btn_hover.png);image: url(:/symble/Images/symbol/System/taskmgr_hover.png);");
    ui->backDeskButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/keyboard2_normal.png);");
    ui->systemButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/tools_normal.png);");
    ui->pushButton_17->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/info3_normal.png);");
...
void Hotel::on_backDeskButton_clicked()   //后台
{
    ...
    ui->radioLabel->setText(radiostring);
     ...
     ui->stackedWidget_3->hide();
     ui->frontDeskButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/taskmgr_normal.png);");
     ui->backDeskButton->setStyleSheet("border-image: url(:/background/Images/background/btn_hover.png);image: url(:/symble/Images/symbol/System/keyboard2_hover.png);");
     ui->systemButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/tools_normal.png);");
     ui->pushButton_17->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/info3_normal.png);");

     ui->pushButton_7->setStyleSheet("border-image: url(:/background/Images/background/catb_normal.png);\n\nfont: 75 11pt '微软雅黑';");
     ui->pushButton_8->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
     ui->pushButton_9->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
     ui->pushButton_43->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
     ui->l1->setStyleSheet("border-image: url(:/icon/Images/icon/items_normal.png);");
     ui->l2->setStyleSheet("border-image: url(:/icon/Images/icon/skills_normal.png);");
     ui->l3->setStyleSheet("border-image: url(:/icon/Images/icon/Navigate/POI2_normal.png);");
     ui->l4->setStyleSheet("border-image: url(:/icon/Images/icon/System/Base_normal.png);");
     ui->arrow1->hide();
     ui->arrow2->hide();
     ui->arrow3->hide();
     ui->arrow4->hide();
...
void Hotel::on_systemButton_clicked()    //系统设置
{
     ...
     if(r.exec ()==QDialog::Accepted)
     {
         ...
         ui->frontDeskButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/taskmgr_normal.png);");
         ui->backDeskButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/keyboard2_normal.png);");
         ui->systemButton->setStyleSheet("border-image: url(:/background/Images/background/btn_hover.png);image: url(:/symble/Images/symbol/System/tools_hover.png);");
         ui->pushButton_17->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/info3_normal.png);");
         ...
         ui->l7->show();
         ui->l8->show();
         ui->pushButton_11->setStyleSheet("border-image: url(:/background/Images/background/catb_normal.png);\n\nfont: 75 11pt '微软雅黑';");
         ui->pushButton_12->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
         ui->pushButton_13->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
         ui->pushButton_16->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
         ui->l5->setStyleSheet("border-image: url(:/icon/Images/icon/modify_normal.png);");
         ui->l6->setStyleSheet("border-image: url(:/icon/Images/icon/System/LOCK_normal.png);");
         ui->l7->setStyleSheet("border-image: url(:/icon/Images/icon/option_normal.png);");
         ui->l8->setStyleSheet("border-image: url(:/icon/Images/icon/System/back_normal.png);");
         ui->arrow5->hide();
         ui->arrow6->hide();
         ui->arrow7->hide();
         ui->arrow8->hide();
                ...
                for (int k = jks[j]; k <= ijke[i][j]; k++)
                 {
                    ...
                    for(int h = 0 ; h <= 1; h++)
                   {
                        ...
                        if(roomTemp->getState() == 1)
                         r[i][j][k][h]->setStyleSheet("border-image: url(:/background/Images/background/cyan.jpg);");     //空房
                        else if(roomTemp->getState() == 2)
                         r[i][j][k][h]->setStyleSheet("border-image: url(:/background/Images/background/red.jpg);");       //入住
                        else if(roomTemp->getState() == 3)
                         r[i][j][k][h]->setStyleSheet("border-image: url(:/background/Images/background/yellow.jpg);");      //预订
                        else
...
{
    ui->pushButton_7->setStyleSheet("border-image: url(:/background/Images/background/catb_hover.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_8->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_9->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_43->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->l1->setStyleSheet("border-image: url(:/icon/Images/icon/items_hover.png);");
    ui->l2->setStyleSheet("border-image: url(:/icon/Images/icon/skills_normal.png);");
    ui->l3->setStyleSheet("border-image: url(:/icon/Images/icon/Navigate/POI2_normal.png);");
    ui->l4->setStyleSheet("border-image: url(:/icon/Images/icon/System/Base_normal.png);");
    ui->arrow1->show();
...
void Hotel::on_pushButton_9_clicked()        //房间平面图
{
    ui->pushButton_7->setStyleSheet("border-image: url(:/background/Images/background/catb_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_8->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_9->setStyleSheet("border-image: url(:/background/Images/background/cata_hover.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_43->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->l1->setStyleSheet("border-image: url(:/icon/Images/icon/items_normal.png);");
    ui->l2->setStyleSheet("border-image: url(:/icon/Images/icon/skills_normal.png);");
    ui->l3->setStyleSheet("border-image: url(:/icon/Images/icon/Navigate/POI2_hover.png);");
    ui->l4->setStyleSheet("border-image: url(:/icon/Images/icon/System/Base_normal.png);");
    ui->arrow1->hide();
    ui->arrow2->hide();
    ui->arrow3->show();
...
{
    ui->pushButton_11->setStyleSheet("border-image: url(:/background/Images/background/catb_hover.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_12->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_13->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_16->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->l5->setStyleSheet("border-image: url(:/icon/Images/icon/modify_hover.png);");
    ui->l6->setStyleSheet("border-image: url(:/icon/Images/icon/System/LOCK_normal.png);");
    ui->l7->setStyleSheet("border-image: url(:/icon/Images/icon/option_normal.png);");
    ui->l8->setStyleSheet("border-image: url(:/icon/Images/icon/System/back_normal.png);");
    ui->arrow5->show();
...
{
    ui->pushButton_11->setStyleSheet("border-image: url(:/background/Images/background/catb_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_12->setStyleSheet("border-image: url(:/background/Images/background/cata_hover.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_13->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_16->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->l5->setStyleSheet("border-image: url(:/icon/Images/icon/modify_normal.png);");
    ui->l6->setStyleSheet("border-image: url(:/icon/Images/icon/System/LOCK_hover.png);");
    ui->l7->setStyleSheet("border-image: url(:/icon/Images/icon/option_normal.png);");
    ui->l8->setStyleSheet("border-image: url(:/icon/Images/icon/System/back_normal.png);");
    ui->arrow5->hide();
    ui->arrow6->show();
...
void Hotel::on_pushButton_13_clicked()     //系统参数设置
{
    ui->pushButton_11->setStyleSheet("border-image: url(:/background/Images/background/catb_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_12->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_13->setStyleSheet("border-image: url(:/background/Images/background/cata_hover.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_16->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->l5->setStyleSheet("border-image: url(:/icon/Images/icon/modify_normal.png);");
    ui->l6->setStyleSheet("border-image: url(:/icon/Images/icon/System/LOCK_normal.png);");
    ui->l7->setStyleSheet("border-image: url(:/icon/Images/icon/option_hover.png);");
    ui->l8->setStyleSheet("border-image: url(:/icon/Images/icon/System/back_normal.png);");
    ui->arrow5->hide();
    ui->arrow6->hide();
    ui->arrow7->show();
...
{
    ui->pushButton_7->setStyleSheet("border-image: url(:/background/Images/background/catb_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_8->setStyleSheet("border-image: url(:/background/Images/background/cata_hover.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_9->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_43->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->l1->setStyleSheet("border-image: url(:/icon/Images/icon/items_normal.png);");
    ui->l2->setStyleSheet("border-image: url(:/icon/Images/icon/skills_hover.png);");
    ui->l3->setStyleSheet("border-image: url(:/icon/Images/icon/Navigate/POI2_normal.png);");
    ui->l4->setStyleSheet("border-image: url(:/icon/Images/icon/System/Base_normal.png);");
    ui->arrow1->hide();
    ui->arrow2->show();
...
void Hotel::on_pushButton_16_clicked()        //恢复设置
{
    ...
    ui->pushButton_12->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_13->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_16->setStyleSheet("border-image: url(:/background/Images/background/cata_hover.png);\nfont: 75 11pt '微软雅黑';");
    ui->l5->setStyleSheet("border-image: url(:/icon/Images/icon/modify_normal.png);");
    ui->l6->setStyleSheet("border-image: url(:/icon/Images/icon/System/LOCK_normal.png);");
    ui->l7->setStyleSheet("border-image: url(:/icon/Images/icon/option_normal.png);");
    ui->l8->setStyleSheet("border-image: url(:/icon/Images/icon/System/back_hover.png);");
    ui->arrow5->hide();
    ui->arrow6->hide();
    ui->arrow7->hide();
    ui->arrow8->show();
...
void Hotel::on_pushButton_17_clicked()               //版权声明
{
    ...
    ui->backDeskButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/keyboard2_normal.png);");
    ui->systemButton->setStyleSheet("border-image: url(:/background/Images/background/btn_normal.png);image: url(:/symble/Images/symbol/System/tools_normal.png);");
    ui->pushButton_17->setStyleSheet("border-image: url(:/background/Images/background/btn_hover.png);image: url(:/symble/Images/symbol/System/info3_hover.png);");
...
void Hotel::on_pushButton_40_clicked()   //续住输入房间号点击确定
{
        ...
        if (fileroom.open(QIODevice::ReadOnly | QIODevice::Text))
        {
            ...
            int t=period (y,m,d,h);
             ...
             ui->dateTimeEdit_3->setMinimumDateTime(currentTime.hotelTime_to_QDate());
             ...
             while(proroom != NULL)
            {
             ...
             ui->dateTimeEdit_3->setMaximumDateTime(currentTime.addDays(max/2));
...
void Hotel::on_pushButton_43_clicked()          //酒店情况
{
    ...
    ui->pushButton_8->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_9->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_43->setStyleSheet("border-image: url(:/background/Images/background/cata_hover.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->l1->setStyleSheet("border-image: url(:/icon/Images/icon/items_normal.png);");
    ui->l2->setStyleSheet("border-image: url(:/icon/Images/icon/skills_normal.png);");
    ui->l3->setStyleSheet("border-image: url(:/icon/Images/icon/Navigate/POI2_normal.png);");
    ui->l4->setStyleSheet("border-image: url(:/icon/Images/icon/System/Base_hover.png);");
    ui->arrow1->hide();
    ui->arrow2->hide();
    ui->arrow3->hide();
    ui->arrow4->show();
...
void Hotel::on_frontDeskButton_pressed()
{

}

void Hotel::on_backDeskButton_pressed()
{

}

void Hotel::on_systemButton_pressed()
{

}

void Hotel::on_pushButton_17_pressed()
{

}

void Hotel::on_pushButton_4_clicked()
{

}

void Hotel::on_pushButton_15_clicked()
{
    ui->pushButton_11->setStyleSheet("border-image: url(:/background/Images/background/catb_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_12->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_13->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
...
void Hotel::on_pushButton_24_clicked()
{
    ui->pushButton_11->setStyleSheet("border-image: url(:/background/Images/background/catb_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_12->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_13->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
...
void Hotel::on_pushButton_48_clicked()
{
    ui->pushButton_11->setStyleSheet("border-image: url(:/background/Images/background/catb_normal.png);\n\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_12->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
    ui->pushButton_13->setStyleSheet("border-image: url(:/background/Images/background/cata_normal.png);\nfont: 75 11pt '微软雅黑';");
...
void Hotel::on_pushButton_49_clicked()
 {
  ...
  void Hotel::on_pushButton_52_clicked()
  {
      QString num=ui ->lineEdit_27 ->text();
      QString rf= "Temp/checkIn/"+num+".txt";
      QFile f(rf);
      if (f.open(QIODevice::ReadOnly | QIODevice::Text))
      {
      ui -> label_161-> setText(num);
      ui ->stackedWidget_2 ->setCurrentIndex(13);
      }
      else
      {
         QMessageBox::information(this,"Warning","This room is not avaliable",QMessageBox::Ok);
      }

  }

  void Hotel::on_pushButton_53_clicked()
  {
  ui ->stackedWidget->setCurrentIndex(0);
  }

  void Hotel::on_pushButton_51_clicked()
  {
  ui ->stackedWidget->setCurrentIndex(0);
  }

  void Hotel::on_pushButton_50_clicked()
  {
    QString num=ui ->lineEdit_27 ->text();;
    QString sum[6];
    sum[1]=ui ->lineEdit_28 ->text();
    sum[2]=ui ->lineEdit_29 ->text();
    sum[3]=ui ->lineEdit_30 ->text();
    sum[4]=ui ->lineEdit_31 ->text();
    sum[5]=ui ->lineEdit_32 ->text();
    for(int i=1;i<=5;i++)
    {
      if(sum[i].toInt()<10)
      sum[i]="0"+sum[i];
    ...
    QString rf= "Temp/checkIn/"+num+".txt";
    QFile f(rf);
    QFile ft("Temp/checkIn/"+num+"x"+".txt");
    QTextStream stream(&f);
    QTextStream streamt(&ft);
    if (f.open(QIODevice::ReadOnly | QIODevice::Text))
    {
     if(ft.open(QIODevice::WriteOnly | QIODevice::Text))
      {
       ...
       while(!stream.atEnd())
       {
        ...
        {
        streamt<<"[ITEM]:1/"<<sum[1]<<";2/"<<sum[2]<<";3/"<<sum[3]<<";4/"<<sum[4]<<";5/"<<sum[5]<<endl;
        }
                  o++;
               }
             }
